...
[![My Skills](https://skillicons.dev/icons?i=java,py,c,react,angular,js,ts,html,css,nodejs,npm,postgres,maven,spring,fastapi,git,vscode,eclipse,idea,figma,latex)](https://skillicons.dev)
<!-- UiPath logo -->
